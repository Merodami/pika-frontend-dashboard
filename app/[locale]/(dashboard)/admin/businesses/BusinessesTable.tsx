...
import type { GetAdminBusinessList200DataItem, GetAdminBusinessList200 } from '@/lib/api/orval-client'
...
export default function BusinessesTable({ locale }: BusinessesTableProps) {
  ...
  const handleSelectionChange = useCallback((selectedRows: GetAdminBusinessList200DataItem[], selectedRowData: Record<string, GetAdminBusinessList200DataItem>) => {
    console.log('Selection changed:', { selectedRows, selectedRowData })
    // TODO: Update bulk actions state
  }, [])

  // Handle row clicks
  const handleRowClick = useCallback((business: GetAdminBusinessList200DataItem) => {
